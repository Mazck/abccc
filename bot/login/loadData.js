...
module.exports = async function (api) {
	...
	const { threadModel, userModel, dashBoardModel, globalModel, paymentModel, gifcodeModel, threadsData, usersData, dashBoardData, globalData, paymentData, GifcodeData ,sequelize } = controller;
	...
	return {
		...
		gifcodeModel: gifcodeModel || null,
		threadsData,
		usersData,
		dashBoardData,
		globalData,
